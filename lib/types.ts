...
export type ActivityType = 'choice'|'baseTenBlocks'|'numberLine'|'ordering'|'punctuation'|'clock'|'money'|'fractions'|'geometry'|'graph'|'drawing'|'rhythm'|'pitch'|'physicalTask'|'traffic'|'matching'|'writing'|'speaking'|'measure';
